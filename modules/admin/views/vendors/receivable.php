...
$this->title = 'Accounts Receivable Summary';
...
<div class='row'>
    ...
    <div id="search-box-payable-orders" class="col-md-12 panel panel-primary">
            ...
            <div id="search-box-current-orders-body" class="collapse in panel-body">
             ...
             <form id='receivable-user-search-form' class='form-inline'>    
                    ...
                    <div class="form-group">
                        <button type="button"
                                ...
                                onclick="Vendors.searchReceivable();">
                            Search
                        </button>
                    </div>
                </form>
    ...
    <div class="col-xs-12 payable-user-body">
        <?php echo $this->render('_user_receivable_list', ['vendors' => $vendors, 'fromDate' => $fromDateDisplay, 'toDate' => $toDateDisplay]);?>
    </div>
</div>
...
<table class="table table-striped table-condensed">
    ...
    <tbody>
        ...
        <tr class="" data-id="<?= $customer->id ?>">
            ...
            <td>$<?php echo $customer->getTotalPayableCost($fromDate, $toDate)?></td>
            <td><a href="/admin/vendors/payable-summary-details?id=<?php echo $customer->id?>&fromDate=<?php echo $fromDate?>&toDate=<?php echo $toDate?>"><i class='fa fa-eye'></i></a></td>       
        </tr>
        <?php }?>
